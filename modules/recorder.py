...
class RecorderFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.device_combo = ctk.CTkComboBox(self, width=400, state="readonly")
        ...
        self.boost_checkbox = ctk.CTkCheckBox(self, text="Aumentar Volume (Boost 3x)", variable=self.boost_var, font=ctk.CTkFont(weight="bold"))
        ...
        self.file_label = ctk.CTkLabel(self, text="Ultimo arquivo: Nenhum", text_color="gray")
    ...
    def start_recording(self, auto_restart=False):
        ...
        if not auto_restart:
            self.record_button.configure(text="Parar Gravacao", fg_color="red", hover_color="darkred")
    ...
    def stop_recording(self):
        self.is_recording = False
        self.record_button.configure(text="Iniciar Gravacao", fg_color="green", hover_color="darkgreen")
    ...
    def save_recording(self):
        ...
        self.after(0, lambda: self.file_label.configure(text=f"Salvo em: {filename}", text_color="gray"))
        return filepath
